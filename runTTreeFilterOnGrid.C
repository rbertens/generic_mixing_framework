void runTTreeFilterOnGrid() {
    ...
    //
    // note that in this example macro the source classes (AliGMFTTreeHeader, AliGMFTTreeTrack,
    ...
    alienHandler->SetAdditionalLibs("libANALYSISalice AliGMFTTreeHeader.cxx AliGMFTTreeTrack.cxx AliAnalysisTaskTTreeFilter.cxx AliGMFTTreeHeader.h AliGMFTTreeTrack.h AliAnalysisTaskTTreeFilter.h");
    alienHandler->SetAnalysisSource("AliGMFTTreeHeader.cxx AliGMFTTreeTrack.cxx AliAnalysisTaskTTreeFilter.cxx");
